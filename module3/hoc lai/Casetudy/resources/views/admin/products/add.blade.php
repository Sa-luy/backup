            ...
            <tr>
                <td>
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="manufacture_day">
                        @if($errors->any())
                ...
                <td>
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  name="expiry">
                        @if($errors->any())
            ...
            <tr>
                <td>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="amouth">
                        @if($errors->any())
        ...
        <tr>
            <td>
                <div class="mb-3">
                    ...
                    <input type="file" accept="image/*" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="file" style="width: 600px">
                    @if($errors->any())
