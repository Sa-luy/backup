                        ...
                        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent">
                                    <h3 class="font-weight-bolder text-info text-gradient">Đăng
                                         kí Tài khoản</h3>
                                ...
                                <div class="card-body">
                                    <form role="form">
                                        ...
                                        <div class="mb-3">
                                            <input type="email" class="form-control" placeholder="Nhập họ tên đầy đủ"
                                                aria-label="Email" aria-describedby="email-addon" name="fullname">
                                        </div>
                                        <label>Email</label>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <input type="email" class="form-control" placeholder="Nhập họ tên đầy đủ"
                                                aria-label="Email" aria-describedby="email-addon" name="address">
                                        </div>
                                    
                                    <label>Nhập lại mật khẩu</label>
                                    <div class="mb-3">
                                        <input type="email" class="form-control" placeholder="mật khẩu"
                                            aria-label="Password" aria-describedby="password-addon" name="nhập lại mật khẩu" >
                                    </div> 
                                        ...
                                        <div class="text-center">
                                            <button type="button" class="btn bg-gradient-info w-100 mt-4 mb-0">Đăng kí</button>
                                        </div>
                                    </form>
                                </div>
